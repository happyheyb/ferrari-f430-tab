var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-f430-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-f430-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-f430-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-f430-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari F430?",
				description: "Get awesome Ferrari F430 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
